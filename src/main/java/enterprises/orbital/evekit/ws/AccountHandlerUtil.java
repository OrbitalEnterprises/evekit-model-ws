...
public class AccountHandlerUtil {
  ...
  private static Response handleIllegalSelector(Exception e) {
  ...
  public static <A extends CachedData> long handleStandardExpiry(ESISyncEndpoint ep, SynchronizedEveAccount acct) {
